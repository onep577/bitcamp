...
<div class="container-fluid">
	...
	<p class="mb-4">배송 중인 내역</p>

	<!-- DataTales Example -->
	<div class="card shadow mb-4">
		<div class="card-header py-3">
			<h6 class="m-0 font-weight-bold text-primary">배송 중인 내역</h6>
	    </div>
		<div class="card-body">
			<div class="table-responsive">
				...
				<div>
					<button type="button" id="deliveryFinishChangeBtn" class="deliveryFinishChangeBtn">배송완료로 변경</button>
				</div>
		</div>
	</div>
