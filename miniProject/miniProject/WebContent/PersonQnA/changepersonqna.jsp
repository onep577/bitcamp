...
#changeBtn:hover, #cancelBtn:hover{
	border-color: #5E2C00;
...
<tr>
	<td>
		...
		<input type="hidden" name="command" value="changeqna">
...
<tr>	
	<td>
		<select id="choice" name="choice" class="td3">
...
<tr>
	<td><input type="text" id="title" name="title" class="td2" value="<%=title %>"></td>
</tr>
...
<tr>
	<td><textarea rows="10" cols="65" id="content" name="content" class="td3"><%=content %></textarea></td>
</tr>
...
$(document).ready(function() {
	...
	$("#choice option:contains(<%=choice %>)").prop("selected", "selected");
	...
	//	alert("choice:" + choice + " title:" + title + " content:" + content);
