...
public class HomeController {
	...
	public String account(Model model) {
	  ...
	  public String loginAf(MemberDto dto, Model model, HttpServletRequest req) throws Exception {
		  ...
		  logger.info("로그인 되었습니다" + new Date());
	  ...
	  public String idCheck(String id, Model model, HttpServletRequest req) throws Exception{
		  
		  boolean b = bitMemberService.idCheck(id);
		  
		  if(b) {
			  logger.info("아아디가 있습니다");
		  }else {
			  logger.info("아아디가 없습니다");
		  }
